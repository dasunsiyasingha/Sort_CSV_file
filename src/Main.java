...
public class FileUploadValidate { 
    ...
    public boolean fileUpload(Stage primaryStage, Label errorMsg){ 
        ...
        fc.getExtensionFilters().add(new FileChooser.ExtensionFilter("CSV 
Files", "*.csv")); 
...
file.getAbsolutePath()); 
    ...
    public boolean fileValidate(ComboBox<String> columnSelector, Label 
errorMsg){ 
    ...
    public void loadCSVColumns(ComboBox<String> columnSelector, Label 
errorMsg) { 
        try (BufferedReader br = new BufferedReader(new 
FileReader(selectedCsvFile))) { 
            ...
            errorMsg.setText("Sorry..! Error reading CSV"); 
            errorMsg.setVisible(true); 
        } 
    } 
 
    public CSVFileData validateNumericColumn(int columnIndex, Label 
errorMsg) { 
        try (BufferedReader br = new BufferedReader(new 
FileReader(selectedCsvFile))) { 
            ...
            while ((line = br.readLine()) != null) { 
                ...
                if (columnIndex >= parts.length) { 
                    errorMsg.setText("Not valid Index. Please Select 
correct column"); 
                    errorMsg.setVisible(true); 
                    return null; 
                } 
                ...
                if (!parts[columnIndex].matches("-?\\d+(\\.\\d+)?")) { 
                    errorMsg.setText("Not have Numerical Data. Please 
select another column.."); 
            ...
            errorMsg.setVisible(false); 
            CSVFileData csvFileData = new CSVFileData(selectedCsvFile, 
columnIndex); 
            return csvFileData; 
